...
return {
  ...
  opts = {
    ...
    spec = {
      ...
      { "<leader>ay", group = "  Copiar selección con contexto (sin abrir)", icon = { icon = "󰆏" } },
      { "<leader>a", group = "AI +21 keymaps", icon = { icon = "" } },
      { "<leader>a", mode = "x", group = "AI Send To", icon = { icon = "" } },
      -- Del plugin: /home/diego/.config/nvim/lua/plugins/opencode-chat.lua @opencode-chat pero lo dejo aca
      {
        { "<leader>em" },
