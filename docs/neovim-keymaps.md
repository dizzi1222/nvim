...
- [🐐 Dizzi Keymaps (Personal Notes)](#-dizzi-keymaps-personal-notes) ⭐ **FIRST REFERENCE**
...
## 🐐 Dizzi Keymaps (Personal Notes)

Apuntes personales con los atajos más importantes y trucos útiles.

### Oil.nvim - Trucazos Especiales
...
- Abre `<space>E` (Snacks picker en cwd)
- Luego `<space>e` (Oil abre en ese directorio)
- Resultado: navegas desde la carpeta que elegiste en Snacks

---

### AI Assistants - Información Crítica

> ⚠️ **IMPORTANTE:** Los atajos de IA funcionan al **seleccionar texto en modo visual (`v`)**

| Assistente     | Tipo               | API            | Gratuito         | Mejor para               |
| -------------- | ------------------ | -------------- | ---------------- | ------------------------ |
| **Copilot**    | Sugerencias inline | ✅ Requiere    | ⚠️ Freemium      | Autocompletado rápido    |
| **Tabnine**    | Sugerencias inline | ❌ No requiere | ✅ Sí (limitado) | Contexto de proyecto     |
| **SuperMaven** | Sugerencias inline | ❌ No requiere | ✅ Sí            | Mejor que Tabnine gratis |
| **OpenCode**   | Chat + Refactor    | ✅ Requiere    | ✅ Sí            | Refactorización completa |

---

### Atajos Importantes Que Debes Saber

#### 🔥 Oil & Snacks Explorer

| Atajo            | Función                     | Ubicación          |
| ---------------- | --------------------------- | ------------------ |
| `-`              | Oil - navegación directorio | Oil buffer         |
| `<space>E`       | Oil flotante                | config/keymaps.lua |
| `<space>e`       | Mini.files / Neo-tree       | config/keymaps.lua |
| `<space><space>` | Snacks finder (archivos)    | Snacks plugin      |

#### 🔥 Notificaciones & Debug

| Atajo       | Función              | Uso                             |
| ----------- | -------------------- | ------------------------------- |
| `<space>n`  | Notification history | Mejor que `:mes` para debuggear |
| `<space>sK` | Inlay hints          | Ver tipos en el código          |

#### 🔥 Copilot & Tabnine

| Atajo   | Función                  | Modo   |
| ------- | ------------------------ | ------ |
| `<Tab>` | **Aceptar sugerencia**   | Insert |
| `<C-]>` | **Descartar sugerencia** | Insert |
| `<M-[>` | Sugerencia anterior      | Insert |
| `<M-]>` | Sugerencia siguiente     | Insert |

#### 🔥 Control de Ventanas

| Atajo         | Función                       |
| ------------- | ----------------------------- |
| `<C-h/j/k/l>` | Navegar ventanas (Tmux-aware) |
| `<C-Space>`   | Cambiar ventana (ciclo)       |
| `<C-w>`       | Acceder modo ventanas         |
| `<C-w>o`      | Cerrar todas las divisiones   |
...
| Atajo       | Función              | Ubicación                |
| ----------- | -------------------- | ------------------------ |
| `<space>cT` | Cambiar tema         | plugins/colorscheme.lua  |
| `<space>P`  | Pywal color          | plugins/pywal-nvim.lua   |
| `<space>uC` | Colorscheme picker   | UI Toggles               |
| `<C-p>`     | Color picker (mouse) | plugins/color-picker.lua |
...
│   ├── copilot.lua
│   ├── copilot-chat.lua
│   ├── tabnine.lua           ← ⚠️ Causa conflicto con cmp.lua
│   ├── supermaven.lua
│   └── opencode-chat.lua
└── .config/lazy.lua          ← Configuración general Lazy
```

> **⚠️ IMPORTANTE:** Si activas Tabnine, debes **eliminar o deshabilitar `cmp.lua`**
...
## AI Assistants (Copilot + OpenCode + Tabnine)
...
### Tabnine (Inline Suggestions)

| Keys        | Description        | Mode | Requisitos                |
| ----------- | ------------------ | ---- | ------------------------- |
| `<Tab>`     | Accept suggestion  | i    | ❌ No API (pero limitado) |
| `<C-]>`     | Dismiss suggestion | i    | ❌ Eliminar cmp.lua       |
| `<C-Enter>` | Accept word        | i    | Contexto de proyecto      |

**Setup:**

```vim
:TabnineLoginWithAuthToken
" Luego abre browser, logea con GitHub y pega tu token
```
